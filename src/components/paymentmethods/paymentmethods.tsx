...
export default function Home() {
  const auth = context();
  const [selected, setPay] = useState("Natwest credit card");
      ...
      <div className="row g-0 border bgwhite rounded mb-4 shadow-sm">
        <div className="col-md-7">
          <div className="paddingall">
            <p className="mt-3 card-text mb-auto"><span className="font-w">{auth.state.name}</span>, get <span className="font-w">5% back</span> (£39.95) as Prime member on your order. <span className="font-w"><Link to="/apply-card">Apply now</Link>.</span></p>
          </div>
        </div>
      ...
      <div className="row g-0 border pad0 bgwhite rounded mb-4 shadow-sm">
        <div className="row row-pad">
          <div className="col-md-1">
            <div className="paddingall">
              <input type="radio" name="payment" onClick={selectPay} checked value={"Natwest credit card"} />
            </div>
          </div>
        ...
        <div className="row row-pad">
          <div className="col-md-1">
            <div className="paddingall">
              <input type="radio" name="payment" onClick={selectPay} value={"Natwest debit card"} />
            </div>
          </div>
          <div className="col-md-11 position-r">
